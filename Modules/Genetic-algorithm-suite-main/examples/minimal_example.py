"""
Minimal example for using a genetic algorithm for finding solutions to problems
involving metabolic models

For re-starting the optimization from a previous population/solution with 
altered parameters refer to minimal_example_restart.py
