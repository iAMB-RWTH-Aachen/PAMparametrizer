...
from genetic_algorithm_suite.ga import Genetic_Algorithm
...
class GAMO():
    ...
    def __init__(self, model=None, fitness_class = "MGenes", 
    ...
    def _init_deap_toolbox(self):
        ...
        # Attribute generator 
        toolbox.register("attr_bool", self.FitEval.attribute_generator,
        ...
        toolbox.register("individual", tools.initRepeat, creator.Individual, 
                         toolbox.attr_bool,  param_attr["number_attributes"])
    ...
    def _init_deap_individual(self):
        ...
        creator.create("Individual", param_ind["individual_type"], fitness=creator.FitnessObj)
    ...
    def _save_population(self, pop, suffix=""):
        ...
        for ind, ind_custom_properties in zip(pop, pop_custom_properties):
            ...
            ind_properties = {
                ...
                "attributes": ",".join([str(j) for j in ind]) # attributes list as string
                }
        ...
        for ind in pop:
            pop_dict["population"].append({
                "attribute_values": [a for a in ind],
