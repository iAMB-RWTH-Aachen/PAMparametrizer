...
def init_toy_parametrization_ga(valid_data_df:pd.DataFrame = valid_data_df,
                                ...
                                mutation_rate:float = 1, # probability with which an attribute (e.g. gene) of an individual is mutated
                                ...
                                filename_save:str = "toy_model_parametrization",
                                genetic_algorithm: Callable = GAPOUniform) -> Callable:
    ...
    fitness_class = "Fitfun_params_gaussian"
    if type(genetic_algorithm) == type(GAPOUniform):
    ...
    ga = genetic_algorithm(
        ...
        filename_save=filename_save, # filename for saving results after every gene flow event
