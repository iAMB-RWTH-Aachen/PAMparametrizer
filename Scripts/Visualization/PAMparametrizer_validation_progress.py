...
result_file_names = ['pam_parametrizer_statistics_2024-05-17.xlsx','pam_parametrizer_statistics_2024-05-21.xlsx']
...
def create_progress_plots(result_file_names, output_file_path, recreate_plot=False):
    ...
    for i,file in enumerate(result_file_names):
        ...
        for iteration, best_indiv_df in best_indiv_grouped:
            ...
            if recreate_plot:
                fig_file_path = os.path.join('Scripts', 'Results',
...
if __name__ == '__main__':
    output_file_path = os.path.join('Scripts','Results', 'error_dataframe_for_checking.xlsx')
